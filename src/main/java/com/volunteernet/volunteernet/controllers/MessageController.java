...
public class MessageController {
    ...
    public ResponseEntity<Object> getAllByChat(@PathVariable Integer chatId) {
        List<MessageResponseDto> messagesByChat = messageService.findAllByChat(chatId);
    ...
    public ResponseEntity<Object> save(@PathVariable Integer chatId,
            @RequestBody SaveMessageDto saveMessageDto) {
        MessageResponseDto messageResponseDto = messageService.save(chatId, saveMessageDto);
